...
public class DWProtocol {
    ...
    public static final int UI_2_eNB_START_CATCH = 113; // 帧码。与定位互斥
    public static final int UI_2_eNB_STOP_CATCH = 114; //
    ...
    public static final int OAM_MSG_PA_RW_CMD = 246;
    public static final int OAM_MSG_SET_DATA_FWD = 301;
    public static final int OAM_MSG_GET_CELL_CFG = 221;
    public static final int UI_2_gNB_REDIRECT_UE = 62;
    public static final int UI_2_eNB_REDIRECT_UE = 180;
    public static final int UI_2_gNB_SET_PLMN = 60;
    public static final int UI_2_eNB_SET_PLMN = 160;
    public static final int OAM_MSG_SET_REF_PWR = 64;
