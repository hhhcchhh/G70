...
public class TracePara {
    ...
    private String pci;
    private String ueMaxTxpwr;
    private String plmn1;
    private String imsi;
    private String splitArfcndl;
    private String splitPcidl;
    ...
    private long cid;
    private int specialCount, special;
    private String specialInit;
    ...
    public TracePara(String id, boolean isLte,int cellId, String imsi, String plmn, String arfcn, String pci, String ue_max_txpwr, int startTac, int maxTac, int timingOffset,
                     ...
                     int reject_code, int rxLevMin, int redirect_2_4g_earfcn, int mob_reject_code,String split_arfcn_dl, int forceCfg, String split_pci_dl) {
        this.id = id;
        this.isLte =isLte;
        this.cellId = cellId;
        this.plmn = plmn;
    ...
    public String getSpecialInit() {
        return specialInit;
    }

    public void setSpecialInit(String specialInit) {
        this.specialInit = specialInit;
    }
    ...
    public String getSplitPcidl() {
        return splitPcidl;
    }

    public void setSplitPcidl(String splitPcidl) {
        this.splitPcidl = splitPcidl;
    }
