...
public class FTPUtil {
	...
	public void startPutFile(final String id, String filePath) {
		startPutFile(id, ZTcpService.build().getHostIp(id), filePath);
	}
	...
	public void startGetFile(String id, String localPath, String fileName) {
		startGetFile( id, ZTcpService.build().getHostIp(id), localPath, fileName);
	}

	public void startGetFile(final String id, String ip, final String localPath, final String fileName){
		state = true;
		new Thread() {
			@Override
			public void run() {
