...
public class DataUtil {
     ...
     * @return
     */
    public static byte[] long2Bytes2(long num) {
    ...
    public static long str2Long(String s, int radix) {
        try {
            long num = Long.parseLong(s, radix);// 把字符串强制转换为数字
            return num;
        } catch (Exception e) {
            return -1;
        }
     ...
     */
    public static byte str2Byte(String s, int radix) {
        try {
    ...
    public static boolean onlyNumeric(String str) {
        if (str == null || str.equals("") || str.equals("--") || str.contains(".")) {
            return false;
        }
