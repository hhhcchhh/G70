...
public class MsgScanRsp {
	...
	int lockStateFirst;		// 1: lock 0: unlock

	int lockStateSecond;		// 1: lock 0: unlock
	...
	public int getLockStateFirst() {
		return lockStateFirst;
	}

	public void setLockStateFirst(int lockStateFirst) {
		this.lockStateFirst = lockStateFirst;
	}

	public int getLockStateSecond() {
		return lockStateSecond;
	}

	public void setLockStateSecond(int lockStateSecond) {
		this.lockStateSecond = lockStateSecond;
	}
	public int getMsgSn() {
		return msgSn;
	}
	...
	public int getMinNoisePowerOrOverload() {
		return minNoisePower;
	}

	public void setMinNoisePowerOrOverload(int minNoisePower) {
		this.minNoisePower = minNoisePower;
	}

	public int getBestPositionOrRssi() {
		return bestPosition;
	}

	public void setBestPositionOrRssi(int bestPosition) {
	...
	public String toString() {
		return "MsgScanRsp{" +
				...
				", minNoisePowerOrOverload=" + minNoisePower +
				", bestPositionOrRssi=" + bestPosition +
				'}';
	}
}
