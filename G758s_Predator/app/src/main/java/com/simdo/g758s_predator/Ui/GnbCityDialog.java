package com.simdo.g758s_predator.Ui;
...
import com.simdo.g758s_predator.Ui.Adapter.CityAdapter;
    ...
    private void showAddCityDialog(int pos) {
        ...
        /*view.findViewById(R.id.tv_to_td).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gpsOffsetTestDialog = new GpsOffsetTestDialog(mContext, dwDevice);
