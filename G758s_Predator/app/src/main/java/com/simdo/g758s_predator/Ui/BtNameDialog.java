...
import com.simdo.g758s_predator.Bean.DeviceInfoBean;
...
public class BtNameDialog extends Dialog implements OnClickListener {
    ...
    public BtNameDialog(Context context, LayoutInflater inflater, String deviceId) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_ok:
                ...
                MessageController.build().setDBBtName(deviceId, device);
                dismiss();
                break;
