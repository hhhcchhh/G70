...
public class GnbProtocol {
    ...
    public static final int OAM_ACK_E_FILE_EMPTY = 9;  //两种情况返回9  1) 黑匣子为空 2）user_data为空
    public static final int OAM_ACK_E_LIC_EXPIRED = 10;  //license过期
    ...
    public static final int UI_2_gNB_CFG_gNB = 10; // 5G 可多次配置, 例如TA改变
    public static final int UI_2_eNB_CFG_gNB = 110; // 4G 可多次配置, 例如TA改变
    public static final int UI_2_gNB_SET_BLACK_UE_LIST = 11; // 5G 黑名单可多次配置, 每次覆盖, 最多8个UE
    public static final int UI_2_gNB_START_LTE_BLACK_UE_LIST = 111; // 4G 黑名单
    public static final int UI_2_gNB_SET_TX_POWER_OFFSET = 12; // 功率衰减, 可多次配置
    public static final int UI_2_gNB_START_CATCH = 13; // 5G启动帧码, 与定位互斥
    public static final int UI_2_eNB_START_CATCH = 113; // 4G启动帧码, 与定位互斥
    public static final int UI_2_gNB_STOP_CATCH = 14; // 5G结束帧码
    public static final int UI_2_eNB_STOP_CATCH = 114; // 4G结束帧码
    public static final int UI_2_gNB_START_TRACE = 15; // 5G 定位, 与帧码互斥, 支持一个目标UE
    public static final int UI_2_gNB_START_LTE_TRACE = 115; // 4G 定位
    public static final int UI_2_gNB_STOP_TRACE = 16; // 5G 结束定位
    public static final int UI_2_gNB_STOP_LTE_TRACE = 116; // 4G 结束定位
    public static final int UI_2_gNB_REBOOT_gNB = 17; // 重启
    public static final int UI_2_gNB_QUERY_gNB_VERSION = 18; // 查询版本, 可多次请求
    public static final int UI_2_gNB_WIFI_CFG = 20;  // 配置WIFI, 重启设备生效

    public static final int UI_2_gNB_START_CONTROL = 30;  // 5G 启动管控
    public static final int UI_2_eNB_START_CONTROL = 130;  // 4G 启动管控
    public static final int UI_2_gNB_STOP_CONTROL = 31;  // 5G 结束管控
    public static final int UI_2_eNB_STOP_CONTROL = 131;  // 4G 结束管控
    public static final int UI_2_gNB_SET_PHONE_TYPE = 61;  // 添加5G苹果标志
    public static final int UI_2_eNB_SET_PHONE_TYPE = 170;  // 添加4G苹果标志
    public static final int UI_2_gNB_GET_GPS_OFFSET = 40;  //
    public static final int UI_2_gNB_SET_NWL_PARA = 41;  //
    /********************************************************************************/
    public static final int gNB_2_UI_REPORT_UE_INFO = 103; // 定位上报
    public static final int gNB_2_UI_LTE_REPORT_UE_INFO = 203; // 定位上报
    ...
    public static final int OAM_MSG_SET_FUNC_CFG  = 222; // 万能钥匙和大杂烩
    ...
    public static final int OAM_MSG_SET_DUAL_STACK = 238;
    ...
    public static final int OAM_MSG_DATA_FWD = 301;
