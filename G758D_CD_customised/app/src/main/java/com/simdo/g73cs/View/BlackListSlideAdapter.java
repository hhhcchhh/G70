...
public class BlackListSlideAdapter extends RecyclerView.Adapter<BlackListSlideAdapter.ViewHolder>
    ...
    public interface ListItemListener {
        void onItemClickListener(int pos, MyUeidBean bean);
        void onItemDeleteListener(int pos, MyUeidBean bean);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int pos) {
        ...
        holder.tv_to_trace.setOnClickListener(view -> {
            if (listener!=null) listener.onItemClickListener(position, blackList.get(position));
        });
        //删除监听
        holder.tv_delete.setOnClickListener(view -> {
            if (listener!=null) listener.onItemDeleteListener(position, blackList.get(position));
            removeData(position);
        });
    }
