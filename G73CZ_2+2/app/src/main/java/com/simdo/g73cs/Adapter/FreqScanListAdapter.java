...
public class FreqScanListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
   private final List<ScanArfcnBean> dataList;
...
//      viewHolder.tv_tac.setTextColor(Color.parseColor("#FFFFFF"));
//      viewHolder.tv_eci.setTextColor(Color.parseColor("#FFFFFF"));
//      viewHolder.tv_ul_arfcn.setTextColor(Color.parseColor("#FFFFFF"));
//      viewHolder.tv_dl_arfcn.setTextColor(Color.parseColor("#FFFFFF"));
//      viewHolder.tv_pci.setTextColor(Color.parseColor("#FFFFFF"));
//      viewHolder.tv_rx.setTextColor(Color.parseColor("#FFFFFF"));
//      viewHolder.tv_pa.setTextColor(Color.parseColor("#FFFFFF"));
//      viewHolder.tv_pk.setTextColor(Color.parseColor("#FFFFFF"));
//      viewHolder.tv_bandwidth.setTextColor(Color.parseColor("#FFFFFF"));
   }
   @Override
