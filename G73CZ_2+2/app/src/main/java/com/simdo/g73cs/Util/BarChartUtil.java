...
public class BarChartUtil {
    ...
    private void initBarChart() {
        ...
        legend.setTextColor(ContextCompat.getColor(ZApplication.getInstance().getContext(), R.color.main_text_color));  //右上角文字颜色
    ...
    public void addBarDataSet(String name, int color){
        this.name = name;
        this.color = color;
        this.textColor = ContextCompat.getColor(ZApplication.getInstance().getContext(), R.color.main_text_color);
