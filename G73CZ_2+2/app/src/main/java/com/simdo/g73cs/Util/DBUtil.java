...
public class DBUtil {
    ...
    public static long insertTraceCfgToDB(JSONArray jsonArray) {
        ...
        try {
            ...
            values.put("TD5", jsonArray.getJSONObject(4).toString());
            values.put("TD6", jsonArray.getJSONObject(5).toString());
            values.put("TD7", jsonArray.getJSONObject(6).toString());
            values.put("TD8", jsonArray.getJSONObject(7).toString());
            values.put("TIME", jsonArray.getString(8));
    ...
    public static JSONArray getTraceCfgToDB() {
        //创建游标对象
        Cursor cursor = db.query("trace_info", new String[]{"TD1", "TD2", "TD3", "TD4", "TD5", "TD6", "TD7", "TD8", "TIME"}, null, null, null, null, null);
        //利用游标遍历所有数据对象
        ...
        while (cursor.moveToNext()) {
            ...
            try {
                ...
                jsonArray.put(new JSONObject(cursor.getString(cursor.getColumnIndex("TD5"))));
                jsonArray.put(new JSONObject(cursor.getString(cursor.getColumnIndex("TD6"))));
                jsonArray.put(new JSONObject(cursor.getString(cursor.getColumnIndex("TD7"))));
                jsonArray.put(new JSONObject(cursor.getString(cursor.getColumnIndex("TD8"))));
