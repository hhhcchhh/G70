...
public class ConnectProgressBar extends View {
     ...
     * 进度条背景颜色
     */
//    private int bgColor = 0xFF3b5750;
        private int bgColor = 0xFFededed;

    /**
     * 进度条颜色
     */
    private int textBgColor = 0xFF1663FF;
...
//            Color.parseColor("#cca75c"), Color.parseColor("#cca75c"),
//            Color.parseColor("#98cc1a"), Color.parseColor("#03c062")};
    private int[] GRADIENT_COLORS = {
            Color.parseColor("#FF1663FF"), Color.parseColor("#FF1663FF"),
            Color.parseColor("#FF1663FF"), Color.parseColor("#FF1663FF")};
