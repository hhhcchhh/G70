                ...
                if (PaCtl.build().isB97502){
                    for (Map.Entry<String, ArrayList<Integer>> entry : freqMap.entrySet()) {
                        switch (entry.getKey()){
                            ...
                            case "N79":
                                if (isAddTD1){
                                    for (Integer value : entry.getValue()) TD1.add(new ArfcnPciBean(String.valueOf(value), "1001"));
                                }
                                break;
                            case "B3":
                            case "B5":
                            ...
                            case "B41":
                                if (isAddTD4){
                                    for (Integer value : entry.getValue()) TD4.add(new ArfcnPciBean(String.valueOf(value), "502"));
                                }
                                break;
                            case "B1":
                                break;
