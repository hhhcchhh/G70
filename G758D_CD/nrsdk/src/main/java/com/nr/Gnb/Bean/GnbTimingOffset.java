...
public class GnbTimingOffset {
    ...
    public void init() {
        ...
        if (list == null || list.equals("")) {*/
            ...
            // N78（3.5）
            arfcnList.add(new TimingBean(633984, 0, 20, 28));
            arfcnList.add(new TimingBean(627264, 0, 12, 24));
            // N79 功放不支持（4.9）
            arfcnList.add(new TimingBean(723360, 0, 14, 254));
            //N1 功放不支持（2.1）
    ...
    private List<TimingBean> arfcnList = new ArrayList<TimingBean>(); // 数据列表
