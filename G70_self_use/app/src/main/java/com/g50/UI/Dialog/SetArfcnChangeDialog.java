...
public class SetArfcnChangeDialog extends Dialog implements MyRecyclerviewAdapter.OnDelArfcnListListener {
		...
		contentView.findViewById(R.id.btn_add_n1).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!text.isEmpty()){
					...
					try {
						PrefUtil.build().setArfcn(Util.int2Json(N1_list,"N1"),"N1"+"cfg");
		...
		contentView.findViewById(R.id.btn_add_n28).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!text.isEmpty()){
					...
					try {
						PrefUtil.build().setArfcn(Util.int2Json(N28_list,"N28"),"N28"+"cfg");
					} catch (JSONException e) {
						e.printStackTrace();
					}
				}
		...
		contentView.findViewById(R.id.btn_add_n41).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!text.isEmpty()){
					...
					try {
						PrefUtil.build().setArfcn(Util.int2Json(N41_list,"N41"),"N41"+"cfg");
					} catch (JSONException e) {
						e.printStackTrace();
					}
				}
		...
		contentView.findViewById(R.id.btn_add_n78).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!text.isEmpty()){
					...
					try {
						PrefUtil.build().setArfcn(Util.int2Json(N78_list,"N78"),"N78"+"cfg");
					} catch (JSONException e) {
						e.printStackTrace();
					}
				}
		...
		contentView.findViewById(R.id.btn_add_n79).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!text.isEmpty()){
					...
					try {
						PrefUtil.build().setArfcn(Util.int2Json(N79_list,"N79"),"N79"+"cfg");
					} catch (JSONException e) {
						e.printStackTrace();
					}
				}
