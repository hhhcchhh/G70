...
public class APPLog {
	...
	public static synchronized void creatLogFile(String msg) {
		...
		FileUtil.build().createFolder(FileProtocol.DIR_Scan);
		...
		if (mLogFilePath == null) {
			I("creatLogFile(): Log文件未创建成功： mLogFilePath == null");
		}
	}
