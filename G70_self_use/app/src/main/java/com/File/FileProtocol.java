...
public class FileProtocol {
    ...
    public final static String FILE_Scan_Freq = FileUtil.build().getSDPath() + File.separator  + DIR_Scan + File.separator;
    // APP日志
    public final static String DIR_LOG = DIR_BASE + File.separator + "Log";
    public final static String ERROR_LOG = DIR_BASE + File.separator + "ErrorLog/"; // APP停止运行LOG目录
