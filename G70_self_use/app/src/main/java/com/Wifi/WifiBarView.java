...
public class WifiBarView extends View {

	private static final String Shader = null;
	...
	private int mAxisYMax = -20; // Y轴最大值
	private int mAxisYMin = -100; // Y轴最小值
	private int mAxisYChangeColorValue = -60; // 柱状变色起始值
	private int mAxisYStep = 5; // Y轴刻度间距
	...
	public WifiBarView(Context context, String title) {
		this(context);
		this.mTitle = title;
	}

	public WifiBarView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public WifiBarView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public WifiBarView(Context context, AttributeSet attrs, int defStyle) {
...
//		initTestData();
		...
		if (mList != null && mList.size() > 0) {
			...
			canvas.drawText(mList.get(0).getName(), axis_start_x + 10, (int)padding_top + 40, myPaint);
		}
		// 画距离
		String strRx = "0.0";
		if (mList != null && mList.size() > 0) {
		...
		for (int j = 0; j < mAxisXLableList.size(); j++) {
			...
			canvas.drawText(str, pos_x - 5, pos_y, myPaint);
		...
		for (int j = 0; j <= yUnit; j++) {
			...
			canvas.drawText(axis, xOffset - mAxisYLableOffset - 3, axis_start_y - ((int)yUnit_value * (j)) + 4, myPaint);// xoffset-2避免字体显示的位置太靠近
		}
		...
		for (int j = 0; j < mList.size(); j++) {
			...
			double color_offset_y = yUnit_value * ((axis_max - color_value) / mAxisYStep);
			// 绘制柱状图
			// 当前设置颜色暂时不用
//			myPaint.setColor(mList.get(j).getColor());
	...
	private void initTestData() {
		mList.add(new DataElement("11", -31, Color.RED));
		mList.add(new DataElement("22", -32, Color.BLUE));
		mList.add(new DataElement("33", -33, Color.GREEN));
		mList.add(new DataElement("44", -34, Color.YELLOW));
		mList.add(new DataElement("55", -35, Color.CYAN));
		mList.add(new DataElement("66", -36, Color.CYAN));
		mList.add(new DataElement("77", -37, Color.CYAN));
		mList.add(new DataElement("77", -38, Color.CYAN));
		mList.add(new DataElement("77", -39, Color.CYAN));
		mList.add(new DataElement("77", -83, Color.CYAN));
		mList.add(new DataElement("77", -86, Color.CYAN));
		mList.add(new DataElement("77", -89, Color.YELLOW));
		
		mList.add(new DataElement("11", -41, Color.RED));
		mList.add(new DataElement("22", -42, Color.BLUE));
		mList.add(new DataElement("33", -43, Color.GREEN));
		mList.add(new DataElement("44", -44, Color.YELLOW));
		mList.add(new DataElement("55", -45, Color.CYAN));
		mList.add(new DataElement("66", -46, Color.CYAN));
		mList.add(new DataElement("77", -47, Color.CYAN));
		mList.add(new DataElement("77", -48, Color.CYAN));
		mList.add(new DataElement("77", -49, Color.CYAN));
		mList.add(new DataElement("77", -93, Color.CYAN));
		mList.add(new DataElement("77", -96, Color.CYAN));
		mList.add(new DataElement("77", -99, Color.YELLOW));
		
		mList.add(new DataElement("11", -51, Color.RED));
		mList.add(new DataElement("22", -52, Color.BLUE));
		mList.add(new DataElement("33", -53, Color.GREEN));
		mList.add(new DataElement("44", -54, Color.YELLOW));
		mList.add(new DataElement("55", -55, Color.CYAN));
		mList.add(new DataElement("66", -56, Color.CYAN));
		mList.add(new DataElement("77", -57, Color.CYAN));
		mList.add(new DataElement("77", -58, Color.CYAN));
		mList.add(new DataElement("77", -59, Color.CYAN));
		mList.add(new DataElement("77", -53, Color.CYAN));
		mList.add(new DataElement("77", -56, Color.CYAN));
		mList.add(new DataElement("77", -59, Color.YELLOW));
		
		mList.add(new DataElement("11", -61, Color.RED));
		mList.add(new DataElement("22", -62, Color.BLUE));
		mList.add(new DataElement("33", -63, Color.GREEN));
		mList.add(new DataElement("44", -64, Color.YELLOW));
		mList.add(new DataElement("55", -65, Color.CYAN));
		mList.add(new DataElement("66", -66, Color.CYAN));
		mList.add(new DataElement("77", -67, Color.CYAN));
		mList.add(new DataElement("77", -68, Color.CYAN));
		mList.add(new DataElement("77", -69, Color.CYAN));
		mList.add(new DataElement("77", -63, Color.CYAN));
		mList.add(new DataElement("77", -66, Color.CYAN));
		mList.add(new DataElement("77", -69, Color.YELLOW));
		
		mList.add(new DataElement("11", -71, Color.RED));
		mList.add(new DataElement("22", -72, Color.BLUE));
		mList.add(new DataElement("33", -73, Color.GREEN));
		mList.add(new DataElement("44", -74, Color.YELLOW));
		mList.add(new DataElement("55", -75, Color.CYAN));
		mList.add(new DataElement("66", -76, Color.CYAN));
		mList.add(new DataElement("77", -77, Color.CYAN));
		mList.add(new DataElement("77", -78, Color.CYAN));
		mList.add(new DataElement("77", -79, Color.CYAN));
		mList.add(new DataElement("77", -73, Color.CYAN));
		mList.add(new DataElement("77", -76, Color.CYAN));
		mList.add(new DataElement("77", -79, Color.YELLOW));
	}
}