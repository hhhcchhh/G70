...
public class AutoRunFreqResultListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
   List<ScanArfcnBean> dataList;
   Context context;
   public AutoRunFreqResultListAdapter(Context context, List<ScanArfcnBean> dataList){
