...
public class TraceCatchFragment extends Fragment {
    ...
    public static TraceUtil mLogicTraceUtilA;
    public static TraceUtil mLogicTraceUtilB;
    public static TraceUtil mLogicTraceUtilC;
...
//    private int time_count = 30;    //轮询时间
    ...
    private void initView(View root) {
        ...
        mTraceChildFragment = new TraceChildFragment();
...
//        setTabWidthSame(tab_layout);
    ...
    private void initData() {
        ...
        mLogicTraceUtilA = new TraceUtil();
        mLogicTraceUtilB = new TraceUtil();
        mLogicTraceUtilC = new TraceUtil();
        // 初始化定位参数
        mLogicTraceUtilA.setTacChange(DWProtocol.CellId.FIRST, false);
        mLogicTraceUtilA.setTxPwr(DWProtocol.CellId.FIRST, 0);
        mLogicTraceUtilA.setCfr(DWProtocol.CellId.FIRST, 1);
        mLogicTraceUtilA.setUeMaxTxpwr(DWProtocol.CellId.FIRST, "10");
        mLogicTraceUtilA.setCid(DWProtocol.CellId.FIRST, 65536);
        mLogicTraceUtilA.setSplit_arfcn_dl(DWProtocol.CellId.FIRST, "0");

        mLogicTraceUtilA.setTacChange(DWProtocol.CellId.SECOND, false);
        mLogicTraceUtilA.setTxPwr(DWProtocol.CellId.SECOND, 0);
        mLogicTraceUtilA.setCfr(DWProtocol.CellId.SECOND, 1);
        mLogicTraceUtilA.setUeMaxTxpwr(DWProtocol.CellId.SECOND, "10");
        mLogicTraceUtilA.setCid(DWProtocol.CellId.SECOND, 65537);
        mLogicTraceUtilA.setSplit_arfcn_dl(DWProtocol.CellId.SECOND, "0");

        mLogicTraceUtilA.setTacChange(DWProtocol.CellId.THIRD, false);
        mLogicTraceUtilA.setTxPwr(DWProtocol.CellId.THIRD, 0);
        mLogicTraceUtilA.setCfr(DWProtocol.CellId.THIRD, 1);
        mLogicTraceUtilA.setUeMaxTxpwr(DWProtocol.CellId.THIRD, "10");
        mLogicTraceUtilA.setCid(DWProtocol.CellId.THIRD, 65538);
        mLogicTraceUtilA.setSplit_arfcn_dl(DWProtocol.CellId.THIRD, "0");

        mLogicTraceUtilA.setTacChange(DWProtocol.CellId.FOURTH, false);
        mLogicTraceUtilA.setTxPwr(DWProtocol.CellId.FOURTH, 0);
        mLogicTraceUtilA.setCfr(DWProtocol.CellId.FOURTH, 1);
        mLogicTraceUtilA.setUeMaxTxpwr(DWProtocol.CellId.FOURTH, "10");
        mLogicTraceUtilA.setCid(DWProtocol.CellId.FOURTH, 65539);
        mLogicTraceUtilA.setSplit_arfcn_dl(DWProtocol.CellId.FOURTH, "0");


        mLogicTraceUtilB.setTacChange(DWProtocol.CellId.FIRST, false);
        mLogicTraceUtilB.setTxPwr(DWProtocol.CellId.FIRST, 0);
        mLogicTraceUtilB.setCfr(DWProtocol.CellId.FIRST, 1);
        mLogicTraceUtilB.setUeMaxTxpwr(DWProtocol.CellId.FIRST, "10");
        mLogicTraceUtilB.setCid(DWProtocol.CellId.FIRST, 65540);
        mLogicTraceUtilB.setSplit_arfcn_dl(DWProtocol.CellId.FIRST, "0");

        mLogicTraceUtilB.setTacChange(DWProtocol.CellId.SECOND, false);
        mLogicTraceUtilB.setTxPwr(DWProtocol.CellId.SECOND, 0);
        mLogicTraceUtilB.setCfr(DWProtocol.CellId.SECOND, 1);
        mLogicTraceUtilB.setUeMaxTxpwr(DWProtocol.CellId.SECOND, "10");
        mLogicTraceUtilB.setCid(DWProtocol.CellId.SECOND, 65541);
        mLogicTraceUtilB.setSplit_arfcn_dl(DWProtocol.CellId.SECOND, "0");

        mLogicTraceUtilB.setTacChange(DWProtocol.CellId.THIRD, false);
        mLogicTraceUtilB.setTxPwr(DWProtocol.CellId.THIRD, 0);
        mLogicTraceUtilB.setCfr(DWProtocol.CellId.THIRD, 1);
        mLogicTraceUtilB.setUeMaxTxpwr(DWProtocol.CellId.THIRD, "10");
        mLogicTraceUtilB.setCid(DWProtocol.CellId.THIRD, 65542);
        mLogicTraceUtilB.setSplit_arfcn_dl(DWProtocol.CellId.THIRD, "0");

        mLogicTraceUtilB.setTacChange(DWProtocol.CellId.FOURTH, false);
        mLogicTraceUtilB.setTxPwr(DWProtocol.CellId.FOURTH, 0);
        mLogicTraceUtilB.setCfr(DWProtocol.CellId.FOURTH, 1);
        mLogicTraceUtilB.setUeMaxTxpwr(DWProtocol.CellId.FOURTH, "10");
        mLogicTraceUtilB.setCid(DWProtocol.CellId.FOURTH, 65543);
        mLogicTraceUtilB.setSplit_arfcn_dl(DWProtocol.CellId.FOURTH, "0");

        mLogicTraceUtilC.setTacChange(DWProtocol.CellId.FIRST, false);
        mLogicTraceUtilC.setTxPwr(DWProtocol.CellId.FIRST, 0);
        mLogicTraceUtilC.setCfr(DWProtocol.CellId.FIRST, 1);
        mLogicTraceUtilC.setUeMaxTxpwr(DWProtocol.CellId.FIRST, "10");
        mLogicTraceUtilC.setCid(DWProtocol.CellId.FIRST, 65544);
        mLogicTraceUtilC.setSplit_arfcn_dl(DWProtocol.CellId.FIRST, "0");

        mLogicTraceUtilC.setTacChange(DWProtocol.CellId.SECOND, false);
        mLogicTraceUtilC.setTxPwr(DWProtocol.CellId.SECOND, 0);
        mLogicTraceUtilC.setCfr(DWProtocol.CellId.SECOND, 1);
        mLogicTraceUtilC.setUeMaxTxpwr(DWProtocol.CellId.SECOND, "10");
        mLogicTraceUtilC.setCid(DWProtocol.CellId.SECOND, 65545);
        mLogicTraceUtilC.setSplit_arfcn_dl(DWProtocol.CellId.SECOND, "0");

        mLogicTraceUtilC.setTacChange(DWProtocol.CellId.THIRD, false);
        mLogicTraceUtilC.setTxPwr(DWProtocol.CellId.THIRD, 0);
        mLogicTraceUtilC.setCfr(DWProtocol.CellId.THIRD, 1);
        mLogicTraceUtilC.setUeMaxTxpwr(DWProtocol.CellId.THIRD, "10");
        mLogicTraceUtilC.setCid(DWProtocol.CellId.THIRD, 65546);
        mLogicTraceUtilC.setSplit_arfcn_dl(DWProtocol.CellId.THIRD, "0");

        mLogicTraceUtilC.setTacChange(DWProtocol.CellId.FOURTH, false);
        mLogicTraceUtilC.setTxPwr(DWProtocol.CellId.FOURTH, 0);
        mLogicTraceUtilC.setCfr(DWProtocol.CellId.FOURTH, 1);
        mLogicTraceUtilC.setUeMaxTxpwr(DWProtocol.CellId.FOURTH, "10");
        mLogicTraceUtilC.setCid(DWProtocol.CellId.FOURTH, 65547);
        mLogicTraceUtilC.setSplit_arfcn_dl(DWProtocol.CellId.FOURTH, "0");
...
//                }
    ...
    public void doWork(String auto_trace_imsi) {
        ...
        if (text.equals(getString(R.string.open))) {
            ...
            if (doStr.equals("-1-1") || doStr.equals("-1")) {
            ...
            mFreqDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface dialog) {
                    if (!mFreqDialog.isUserCancel()) {
                        ...
                        mLogicTraceUtilA.setAirSync(DWProtocol.CellId.FIRST, airSync);
                        mLogicTraceUtilA.setAirSync(DWProtocol.CellId.SECOND, airSync);
                        mLogicTraceUtilA.setAirSync(DWProtocol.CellId.THIRD, airSync);
                        mLogicTraceUtilA.setAirSync(DWProtocol.CellId.FOURTH, airSync);
                        mLogicTraceUtilB.setAirSync(DWProtocol.CellId.FIRST, airSync);
                        mLogicTraceUtilB.setAirSync(DWProtocol.CellId.SECOND, airSync);
                        mLogicTraceUtilB.setAirSync(DWProtocol.CellId.THIRD, airSync);
                        mLogicTraceUtilB.setAirSync(DWProtocol.CellId.FOURTH, airSync);
                        mLogicTraceUtilC.setAirSync(DWProtocol.CellId.FIRST, airSync);
                        mLogicTraceUtilC.setAirSync(DWProtocol.CellId.SECOND, airSync);
                        mLogicTraceUtilC.setAirSync(DWProtocol.CellId.THIRD, airSync);
                        mLogicTraceUtilC.setAirSync(DWProtocol.CellId.FOURTH, airSync);
...
//                                }).start();
            ...
            mLogicTraceUtilA.setImsi(0, auto_trace_imsi);
            mLogicTraceUtilA.setImsi(1, auto_trace_imsi);
            mLogicTraceUtilA.setImsi(2, auto_trace_imsi);
            mLogicTraceUtilA.setImsi(3, auto_trace_imsi);
            mLogicTraceUtilB.setImsi(0, auto_trace_imsi);
            mLogicTraceUtilB.setImsi(1, auto_trace_imsi);
            mLogicTraceUtilB.setImsi(2, auto_trace_imsi);
            mLogicTraceUtilB.setImsi(3, auto_trace_imsi);
            mLogicTraceUtilC.setImsi(0, auto_trace_imsi);
            mLogicTraceUtilC.setImsi(1, auto_trace_imsi);
            mLogicTraceUtilC.setImsi(2, auto_trace_imsi);
            mLogicTraceUtilC.setImsi(3, auto_trace_imsi);

            mLogicTraceUtilA.setPlmn(0, tracePlmn);
            mLogicTraceUtilA.setPlmn(1, tracePlmn);
            mLogicTraceUtilA.setPlmn(2, tracePlmn);
            mLogicTraceUtilA.setPlmn(3, tracePlmn);
            mLogicTraceUtilB.setPlmn(0, tracePlmn);
            mLogicTraceUtilB.setPlmn(1, tracePlmn);
            mLogicTraceUtilB.setPlmn(2, tracePlmn);
            mLogicTraceUtilB.setPlmn(3, tracePlmn);
            mLogicTraceUtilC.setPlmn(0, tracePlmn);
            mLogicTraceUtilC.setPlmn(1, tracePlmn);
            mLogicTraceUtilC.setPlmn(2, tracePlmn);
            mLogicTraceUtilC.setPlmn(3, tracePlmn);
            return;
        }
    ...
    private void setAllLogicTraceUtilImsi(String imsi) {
        ...
        mLogicTraceUtilA.setImsi(0, imsi);
        mLogicTraceUtilA.setImsi(1, imsi);
        mLogicTraceUtilA.setImsi(2, imsi);
        mLogicTraceUtilA.setImsi(3, imsi);
        mLogicTraceUtilB.setImsi(0, imsi);
        mLogicTraceUtilB.setImsi(1, imsi);
        mLogicTraceUtilB.setImsi(2, imsi);
        mLogicTraceUtilB.setImsi(3, imsi);
        mLogicTraceUtilC.setImsi(0, imsi);
        mLogicTraceUtilC.setImsi(1, imsi);
        mLogicTraceUtilC.setImsi(2, imsi);
        mLogicTraceUtilC.setImsi(3, imsi);
    }

    private void setAllLogicTraceUtilImsiTest(String imsi) {
        AppLog.D("setAllLogicTraceUtilImsiTest");
        mLogicTraceUtilA.setImsi(0, imsi);
        mLogicTraceUtilA.setImsi(1, mCfgTraceChildFragment.getActv_imsi2().getText().toString());
        mLogicTraceUtilA.setImsi(2, mCfgTraceChildFragment.getActv_imsi3().getText().toString());
        mLogicTraceUtilA.setImsi(3, mCfgTraceChildFragment.getActv_imsi4().getText().toString());
        mLogicTraceUtilB.setImsi(0, mCfgTraceChildFragment.getActv_imsi5().getText().toString());
        mLogicTraceUtilB.setImsi(1, mCfgTraceChildFragment.getActv_imsi6().getText().toString());
        mLogicTraceUtilB.setImsi(2, mCfgTraceChildFragment.getActv_imsi7().getText().toString());
        mLogicTraceUtilB.setImsi(3, mCfgTraceChildFragment.getActv_imsi8().getText().toString());
        mLogicTraceUtilC.setImsi(0, mCfgTraceChildFragment.getActv_imsi9().getText().toString());
        mLogicTraceUtilC.setImsi(1, mCfgTraceChildFragment.getActv_imsi10().getText().toString());
        mLogicTraceUtilC.setImsi(2, mCfgTraceChildFragment.getActv_imsi11().getText().toString());
        mLogicTraceUtilC.setImsi(3, mCfgTraceChildFragment.getActv_imsi12().getText().toString());
    }
...
//                if (isResetBlack) return;
                if (rsp.getRspValue() == DWProtocol.OAM_ACK_OK) {
                    ...
                    if (Integer.parseInt(arfcn[0]) > 100000)
                        PaCtl.build().initPA(id, arfcn[0], DeviceUtil.getChannelNumByarfcn_3G758_CX(arfcn[0]));
                    else
                        PaCtl.build().initLtePA(id, arfcn[0], DeviceUtil.getChannelNumByarfcn_3G758_CX(arfcn[0]));
...
//                                        mCfgTraceChildFragment.setcfgEnable(-1, true);
    ...
    private void updateParamAndStart(String id, String arfcnStr, String pci, int cell_id) {
        ...
        TraceUtil mLogicTraceUtil = DeviceUtil.getTraceUtilByLogicIndex(logicIndex);
                ...
                if (rsp.getRspValue() == DWProtocol.OAM_ACK_OK) {
                    if (traceType == GnbBean.DW_State.CFG_TRACE) {
                        ...
                        if (Integer.parseInt(traceUtil.getArfcn(rsp.getCellId())) > 100000)
                            PaCtl.build().openPA(id, traceUtil.getArfcn(rsp.getCellId()), DeviceUtil.getChannelNumByarfcn_3G758_CX(traceUtil.getArfcn(rsp.getCellId()))); // 开PA
                        else
                            PaCtl.build().openLtePA(id, traceUtil.getArfcn(rsp.getCellId()), DeviceUtil.getChannelNumByarfcn_3G758_CX(traceUtil.getArfcn(rsp.getCellId()))); // 开Lte PA
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                // 5、发开始定位指令
    ...
    public void onStartTraceRsp(String id, GnbTraceRsp rsp) {
        ...
        if (rsp.getCmdRsp() != null) {
            ...
            if (!value.isEmpty() && LteBand.earfcn2band(Integer.parseInt(value)) == 40 && mainB40Success == 0) {
                ...
                MainActivity.getInstance().getDeviceList().get(indexById).getTraceUtil().setWorkState(cell_id, GnbBean.DW_State.IDLE);
...
//                    MainActivity.getInstance().getDeviceList().get(indexById).getTraceUtil().setEnable(cell_id, true);
                    MainActivity.getInstance().getDeviceList().get(indexById).getTraceUtil().setWorkState(cell_id, GnbBean.DW_State.TRACE);
...
//                        if (MainActivity.getInstance().isInBlackList(imsi)) return;
                        ...
                        if (traceImsi.equals(imsi)) {   //只有确定是定位的设备时才刷新页面
                            MainActivity.getInstance().getDeviceList().get(indexById).getTraceUtil().setRsrp(cell_id, rsrp);
                            // 刷新处于工作状态
                            freshDoWorkState(type, logicIndex, cell_id, MainActivity.getInstance().getDeviceList().get(indexById).getTraceUtil().getImsi(cell_id)
                                    , traceUtil.getArfcn(cell_id), traceUtil.getPci(cell_id));

                            //数传定位配置给单兵
//                            if (mSettingFragment.getDwSettingFragment() != null) {
...
//                                mImsiList.get(j).setArfcn(traceArfcn);
                    ...
                    setIsStartCatchHandler(logicIndex, true);
                    mCatchChildFragment.resetShowData(false); // 刷新侦码列表视图
                    if (MainActivity.getInstance().getDeviceList().get(indexById).getTraceUtil().getWorkState(cell_id) == GnbBean.DW_State.TRACE && !isRsrpStart && rsp.getRsrp() > 5) {
    ...
    private void doDBWork(String id, String arfcn, String pci) {
        ...
        */
        ...
        //空口模式时偏为-1
        final String sync_mode = PrefUtil.build().getValue("sync_mode_cx", "Air").toString();
...
//            if (!isStartCatch())
            ...
            int channelNum = DeviceUtil.getChannelNum(logicIndex, cell_id);
            MainActivity.getInstance().setConfigInfo(channelNum, type, arfcn, pci, imsi);
        }
    }
...
//    }
    ...
    (LinkedList<ArfcnPciBean> td1, LinkedList<ArfcnPciBean> td2, LinkedList<ArfcnPciBean> td3, LinkedList<ArfcnPciBean> td4) {
        if (td1 != null || td2 != null || td3 != null || td4 != null) {
            try {
                ...
                jsonObject1.put("pci", mLogicTraceUtilA.getPci(0));
                jsonObject1.put("imsi", mLogicTraceUtilA.getImsi(0));
                jsonArray.put(jsonObject1);
                ...
                jsonObject2.put("pci", mLogicTraceUtilA.getPci(1));
                jsonObject2.put("imsi", mLogicTraceUtilA.getImsi(1));
                jsonArray.put(jsonObject2);
                ...
                jsonObject3.put("pci", mLogicTraceUtilA.getPci(2));
                jsonObject3.put("imsi", mLogicTraceUtilA.getImsi(2));
                ...
                jsonObject4.put("pci", mLogicTraceUtilA.getPci(3));
                jsonObject4.put("imsi", mLogicTraceUtilA.getImsi(3));
    ...
    private void startRunWork() {
        ...
        for (int i = 0; i < MainActivity.getInstance().getDeviceList().size(); i++) {
            ...
            TraceUtil traceUtil = DeviceUtil.getTraceUtilByDeviceName(name);
            String id = MainActivity.getInstance().getDeviceList().get(i).getRsp().getDeviceId();
            int logicIndex = DeviceUtil.getLogicIndexById(id);
            long timeMillis = System.currentTimeMillis();
            //boolean isGpsSync = MainActivity.getInstance().getDeviceList().get(i).getRsp().getGpsSyncState() == GnbStateRsp.Gps.SUCC;

            traceUtil.setAirSync(DWProtocol.CellId.FIRST, isAirSync ? 1 : 0);
            traceUtil.setAirSync(DWProtocol.CellId.SECOND, isAirSync ? 1 : 0);
            traceUtil.setAirSync(DWProtocol.CellId.THIRD, isAirSync ? 1 : 0);
            traceUtil.setAirSync(DWProtocol.CellId.FOURTH, isAirSync ? 1 : 0);

            traceUtil.setAtCmdTimeOut(DWProtocol.CellId.FIRST, timeMillis);
            traceUtil.setAtCmdTimeOut(DWProtocol.CellId.SECOND, timeMillis);
            traceUtil.setAtCmdTimeOut(DWProtocol.CellId.THIRD, timeMillis);
            traceUtil.setAtCmdTimeOut(DWProtocol.CellId.FOURTH, timeMillis);
...
//                AppLog.D("arfcnBeanHashMap.get(\"TD\" + DeviceUtil.getChannelNum(logicIndex, cell_id))" + "TD" + DeviceUtil.getChannelNum(logicIndex, cell_id));
                if (!traceUtil.getImsi(cell_id).isEmpty() &&
...
//            }).start();
    ...
    private void nextArfcnInSameBand(int channelNum, String value, String pci,
                                     int arfcnListSize) {
        ...
        TraceUtil mTraceUtil = DeviceUtil.getTraceUtilByLogicIndex(logicIndex);
        AppLog.D("mHandler 1" + channelNum + " change arfcn = " + value + ", autoArfcnIndex" + (channelNum - 1) + " = " + autoArfcnIndex);
        //更新页面信息
        freshDoWorkState(0, logicIndex, cell_id, mTraceUtil.getImsi(cell_id), value, mTraceUtil.getPci(cell_id));
        MessageController.build().setArfcn(MainActivity.getInstance().getDeviceList().get(index).getRsp().getDeviceId(), cell_id, value);
    ...
    private void nextArfcnInDiffBand(int channelNum, String value, String pci,
        ...
        TraceUtil mTraceUtil = DeviceUtil.getTraceUtilByLogicIndex(logicIndex);
        String deviceId = MainActivity.getInstance().getDeviceList().get(logicIndex).getRsp().getDeviceId();
        ...
        if (DeviceUtil.isNr(channelNum))
            MessageController.build().stopDWNrTrace(deviceId, DWProtocol.CellId.FOURTH);
        else
            MessageController.build().stopDWLteTrace(deviceId, DWProtocol.CellId.FOURTH);
        PaCtl.build().closePAByArfcn(deviceId, !isNr, mTraceUtil.getArfcn(cell_id), DeviceUtil.getChannelNumByarfcn_3G758_CX(mTraceUtil.getArfcn(cell_id)));
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (sendIndex == 2) {
                        ...
                        for (DeviceInfoBean deviceInfoBean : MainActivity.getInstance().getDeviceList()) {
                            AppLog.D("handler 1 deviceInfoBean.getRsp().getDeviceId() " + deviceInfoBean.getRsp().getDeviceId());
                            AppLog.D("handler 1 setDWDataFwd" + "json = " + json);
                                ...
                                if (countLost < 6) {
                                    if (rsrp != -1) {
                                        mTraceChildFragment.setRsrpValue(
                                                mCfgTraceChildFragment.isYiguangChecked(), cell_id, i, rsrp);
                                    }
                                } else {
                                    //掉线，恢复轮询
                                    if (ifRecountNum) {
...
//                                        updateParam(3, value, mTraceUtilNr.getPci(DWProtocol.CellId.FOURTH));
                                        //更新页面信息
                                        freshDoWorkState(0, 1, DWProtocol.CellId.FOURTH, mLogicTraceUtilA.getImsi(DWProtocol.CellId.FOURTH), value, mLogicTraceUtilA.getPci(DWProtocol.CellId.FOURTH));
                                        ...
                                        MessageController.build().stopDWLteTrace(deviceId, DWProtocol.CellId.FOURTH);
                                        PaCtl.build().closePAByArfcn(deviceId, true, mLogicTraceUtilA.getArfcn(DWProtocol.CellId.FOURTH), DeviceUtil.getChannelNumByarfcn_3G758_CX(arfcn));
                    ...
                    if (MainActivity.getInstance().getDeviceList().size() > 0 && time_count != 0 && !isStartCatchHandler6) {
                        ...
                        for (int i = 0; i < arfcnList.size(); i++) {
                            if (i >= autoArfcnIndex5) {
                                String value = String.valueOf(arfcnList.get(i).getArfcn());    //下一个准备轮询的arfcn值
                                String pci = String.valueOf(arfcnList.get(i).getPci());    //下一个准备轮询的arfcn值
                                if (NrBand.earfcn2band(Integer.parseInt(value)) == NrBand.earfcn2band(Integer.parseInt(mLogicTraceUtilB.getArfcn(DWProtocol.CellId.SECOND)))) {
                                    //要切换的值在同频带
                    ...
                    if (MainActivity.getInstance().getDeviceList().size() > 0 && time_count != 0 && !isStartCatchHandler7) {
                        ...
                        for (int i = 0; i < arfcnList.size(); i++) {
                            if (i >= autoArfcnIndex6) {
                                String value = String.valueOf(arfcnList.get(i).getArfcn());    //下一个准备轮询的arfcn值
                                String pci = String.valueOf(arfcnList.get(i).getPci());    //下一个准备轮询的arfcn值
                                if (NrBand.earfcn2band(Integer.parseInt(value)) == NrBand.earfcn2band(Integer.parseInt(mLogicTraceUtilB.getArfcn(DWProtocol.CellId.THIRD)))) {
                                    //要切换的值在同频带
                                    nextArfcnInSameBand(7, value, pci, arfcnList.size());
                                } else {
                                    //不同频带
                                    nextArfcnInDiffBand(7, value, pci, arfcnList.size());
                                    return;
                                }
                                mLogicTraceUtilB.setArfcn(DWProtocol.CellId.FIRST, value); //更新当前配置的值
                                break;
                    ...
                    if (MainActivity.getInstance().getDeviceList().size() > 0 && time_count != 0 && !isStartCatchHandler8) {
                        ...
                        for (int i = 0; i < arfcnList.size(); i++) {
                            if (i >= autoArfcnIndex7) {
                                String value = String.valueOf(arfcnList.get(i).getArfcn());    //下一个准备轮询的arfcn值
                                String pci = String.valueOf(arfcnList.get(i).getPci());    //下一个准备轮询的arfcn值
                                if (NrBand.earfcn2band(Integer.parseInt(value)) == NrBand.earfcn2band(Integer.parseInt(mLogicTraceUtilB.getArfcn(DWProtocol.CellId.FOURTH)))) {
                                    //要切换的值在同频带
                ...
                case 19:
                    ...
                    if (MainActivity.getInstance().getDeviceList().size() > 0 && time_count != 0 && !isStartCatchHandler9) {
                ...
                case 20:
                    ...
                    if (MainActivity.getInstance().getDeviceList().size() > 0 && time_count != 0 && !isStartCatchHandler10) {
                ...
                case 21:
                    ...
                    if (MainActivity.getInstance().getDeviceList().size() > 0 && time_count != 0 && !isStartCatchHandler11) {
                ...
                case 22:
                    ...
                    if (MainActivity.getInstance().getDeviceList().size() > 0 && time_count != 0 && !isStartCatchHandler12) {
