...
public class DeviceUtil {
    ...
    public static TraceUtil getTraceUtilByLogicIndex(int logicIndex) {
        switch (logicIndex) {
            case 0:
                return TraceCatchFragment.mLogicTraceUtilA;
            case 1:
                return TraceCatchFragment.mLogicTraceUtilB;
            case 2:
                return TraceCatchFragment.mLogicTraceUtilC;
        }
        return null;
    }

    public static TraceUtil getTraceUtilByDeviceName(String devName) {
        if (devName.contains(devA)) return TraceCatchFragment.mLogicTraceUtilA;
        else if (devName.contains(devB)) return TraceCatchFragment.mLogicTraceUtilB;
        else return TraceCatchFragment.mLogicTraceUtilC;
    }

    public static int getChannelNumByarfcn_3G758_CX(String arfcn) {
