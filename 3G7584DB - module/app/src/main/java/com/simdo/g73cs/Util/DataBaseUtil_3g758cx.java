...
//
public class DataBaseUtil_3g758cx {
    ...
    public static long insertTraceCfgToDB(JSONArray jsonArray) {
        ...
        try {
            values.put("yiguangList", jsonArray.getJSONObject(0).toString());
            values.put("liandianList", jsonArray.getJSONObject(1).toString());
            values.put("TIME", jsonArray.getString(2));
    ...
    //获取所有历史记录,每2条是一条历史记录（yiguang\liandian）
    /*
     * [{"arfcnPciJsonArray":["2561/645", "16565/645"],"imsi":"26565654515"},
     * {"arfcnPciJsonArray":["2561/645", "16565/645"],imsi":"26565654515"},
     * {"arfcnPciJsonArray":["2561/645", "16565/645"],imsi":"26565654515"},
     * {"arfcnPciJsonArray":["2561/645", "16565/645"],imsi":"26565654515"},
     */
    ...
    public static JSONArray getTraceCfgToDB() {
        //创建游标对象
        Cursor cursor = db.query("trace_info", new String[]{"yiguangList", "liandianList", "TIME"}, null, null, null, null, null);
        //利用游标遍历所有数据对象
        ...
        while (cursor.moveToNext()) {
            ...
            Log.d("DataBaseUtil_3g758cx", "Column: " + columnName + ", Value: " + columnValue);
            try {
                jsonArray.put(new JSONObject(cursor.getString(cursor.getColumnIndex("yiguangList"))));
                jsonArray.put(new JSONObject(cursor.getString(cursor.getColumnIndex("liandianList"))));
