    ...
    private boolean bandInDevice(String id, String key) {
        ...
        switch (key) {
            ...
            case "B41":
                ...
                break;
            default:
                if (key.contains("N78") || key.contains("B1") || key.contains("B3"))
                    logicIndexByKey = 0;
                else if (key.contains("N41") || key.contains("B40")) logicIndexByKey = 1;
...
//        }
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            chan_id.add(DeviceUtil.getCellIdByChannelNum(DeviceUtil.getChannelNumByarfcn_3G758_CX(String.valueOf(list.get(i)))));
        }
