...
public class FreqUtil {
     ...
     * */
    public LinkedList<LinkedList<ArfcnPciBean>> decFreqList_3g758cx(LinkedList<ScanArfcnBean> mFreqList) {
        // 调整顺序
        // 移广优先级： 5G:  N41---N28---N79   4G：B40-B3-B41-B39-B8-B34
        // 联电优先级： 5G:  N78->N1  4G：B1->B3->B5->B8   4/5G并存：B1->N1
        ...
        LinkedList<ArfcnPciBean> TD1, TD2, TD3, TD4, TD5, TD6, TD7, TD8, TD9, TD10, TD11, TD12; // 第一方案的列表
        LinkedList<ArfcnPciBean> _TD1, _TD2, _TD3, _TD4, _TD5, _TD6, _TD7, _TD8, _TD9, _TD10, _TD11, _TD12; // 第二方案的列表
        TD1 = new LinkedList<>();
        TD2 = new LinkedList<>();
        TD3 = new LinkedList<>();
        TD4 = new LinkedList<>();
        ...
        _TD8 = new LinkedList<>();
        _TD9 = new LinkedList<>();
        _TD10 = new LinkedList<>();
        _TD11 = new LinkedList<>();
        _TD12 = new LinkedList<>();
        ...
        for (ScanArfcnBean bean : freqList) {
            ...
            if (arfcn > 100000) {
                ...
                if (PaCtl.build().is3G758) {
                    switch (band) {
                        case 41:
                            tdData = getTdData(freqList, TD7, _TD7, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD7 = tdData.get(0).getTD1();
                                _TD7 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                        case 78:    //全加到通道一主频点中
                        case 79:
                            tdData = getTdData(freqList, TD1, _TD1, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD1 = tdData.get(0).getTD1();
                                _TD1 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                        case 1:
                            tdData = getTdData(freqList, TD3, _TD3, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD3 = tdData.get(0).getTD1();
                                _TD3 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                        case 3:
                            tdData = getTdData(freqList, TD9, _TD9, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD9 = tdData.get(0).getTD1();
                                _TD9 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                        case 28:
                            tdData = getTdData(freqList, TD5, _TD5, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD5 = tdData.get(0).getTD1();
                                _TD5 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                    }
                ...
                if (PaCtl.build().is3G758) {
                    switch (band) {
                        case 3:
                            tdData = getTdData(freqList, TD4, _TD4, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD4 = tdData.get(0).getTD1();
                                _TD4 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                        case 5:
                        case 8:
                            tdData = getTdData(freqList, TD11, _TD11, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD11 = tdData.get(0).getTD1();
                                _TD11 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                        case 34:
                            tdData = getTdData(freqList, TD12, _TD12, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD12 = tdData.get(0).getTD1();
                                _TD12 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                        case 39:
                            tdData = getTdData(freqList, TD10, _TD10, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD10 = tdData.get(0).getTD1();
                                _TD10 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                        case 40:
                            if (TD6.size() >= TD8.size()) {
                                tdData = getTdData(freqList, TD8, _TD8, bandNumMap, bean, arfcn, band);
                                if (tdData != null) {
                                    TD8 = tdData.get(0).getTD1();
                                    _TD8 = tdData.get(0).getTD2();
                                    bandNumMap = tdData.get(0).getBandNumMap();
                                }
                                break;
                            } else {
                                tdData = getTdData(freqList, TD6, _TD6, bandNumMap, bean, arfcn, band);
                                if (tdData != null) {
                                    TD6 = tdData.get(0).getTD1();
                                    _TD6 = tdData.get(0).getTD2();
                                    bandNumMap = tdData.get(0).getBandNumMap();
                                }
                            }
                        case 41:
                            ...
                            break;
                        case 1:
                            tdData = getTdData(freqList, TD2, _TD2, bandNumMap, bean, arfcn, band);
                            if (tdData != null) {
                                TD2 = tdData.get(0).getTD1();
                                _TD2 = tdData.get(0).getTD2();
                                bandNumMap = tdData.get(0).getBandNumMap();
                            }
                            break;
                    }
    ...
    private ArrayList<TdDataBean> getTdData(LinkedList<ScanArfcnBean> freqList, LinkedList<ArfcnPciBean> TD1, LinkedList<ArfcnPciBean> TD2, HashMap<String, LinkedList<SizeBean>> bandNumMap, ScanArfcnBean bean, int arfcn, int band) {
        ...
        if (!listIsContains(TD1, arfcn)) {
            ...
            if (resultBeans.get(0).getTD2().size() > 0)
                maxRsrp = resultBeans.get(0).getTD2().get(0).getRsrp();
