...
public class TraceUtil {
    ...
    public TraceUtil() {
        firstCell = new TraceBean(GnbBean.DW_State.IDLE);
        secondCell = new TraceBean(GnbBean.DW_State.IDLE);
        thirdCell = new TraceBean(GnbBean.DW_State.IDLE);
        fourthCell = new TraceBean(GnbBean.DW_State.IDLE);
    }
