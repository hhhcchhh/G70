...
public class TracePara {
    private String plmn, arfcn, pci, ueMaxTxpwr, plmn1, imsi;
    private int cellId, startTac, maxTac, timingOffset, workMode, airSync, ulRbOffset, ssbBitmap, traceTacChangeDelay, stopCount, bandWidth, cfr, swapRf;
    private int rejectCode, rxLevMin, pa, pk, mobRejectCode, redirect2LteArfcn;
    private long cid;
    private boolean tracing;
    private boolean enableChangeTac;
    ...
    public TracePara(String id, boolean isLte, int cellId, String imsi, String plmn, String arfcn, String pci, String ue_max_txpwr, int startTac, int maxTac, int timingOffset,
                     ...
                     int reject_code, int rxLevMin, int redirect_2_4g_earfcn, int mob_reject_code, String split_arfcn_dl) {
        this.id = id;
        this.isLte = isLte;
        this.cellId = cellId;
        this.plmn = plmn;
