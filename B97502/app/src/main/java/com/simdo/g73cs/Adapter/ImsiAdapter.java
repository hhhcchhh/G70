...
public class ImsiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    Drawable ic_cell_1, ic_cell_2, ic_cell_3, ic_cell_4;
    public ImsiAdapter(Context context, List<ImsiBean> dataList) {
        this.context = context;
        this.dataList = dataList;
        ic_cell_1 = context.getResources().getDrawable(R.mipmap.ic_cell_1);
        ic_cell_2 = context.getResources().getDrawable(R.mipmap.ic_cell_2);
        ic_cell_3 = context.getResources().getDrawable(R.mipmap.ic_cell_3);
        ic_cell_4 = context.getResources().getDrawable(R.mipmap.ic_cell_4);
        // 这一步必须要做,否则不会显示.
        ic_cell_1.setBounds(0, 0, ic_cell_1.getMinimumWidth(), ic_cell_1.getMinimumHeight());
        ic_cell_2.setBounds(0, 0, ic_cell_2.getMinimumWidth(), ic_cell_2.getMinimumHeight());
        ic_cell_3.setBounds(0, 0, ic_cell_3.getMinimumWidth(), ic_cell_3.getMinimumHeight());
        ic_cell_4.setBounds(0, 0, ic_cell_4.getMinimumWidth(), ic_cell_4.getMinimumHeight());
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Drawable icon = ic_cell_1;
        switch (item.getCellId()){
            case 1:
                icon = ic_cell_2;
                break;
            case 2:
        ...
        viewHolder.tv_imsi.setCompoundDrawables(null, null, icon, null);
