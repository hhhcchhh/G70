...
public class BlackListSlideAdapter extends RecyclerView.Adapter<BlackListSlideAdapter.ViewHolder>
    ...
    public interface ListItemListener {
        ...
        void onItemRemoveListener(MyUeidBean myUeidBean);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int pos) {
        ...
        //标记已读监听
        holder.tv_to_trace.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void removeData(int position) {
        MyUeidBean myUeidBean = blackList.get(position);
        blackList.remove(position);
        PrefUtil.build().putUeidList(blackList);
        notifyDataSetChanged();
        if (listener!=null) listener.onItemRemoveListener(myUeidBean);
    }
}