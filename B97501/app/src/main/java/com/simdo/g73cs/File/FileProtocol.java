...
public class FileProtocol {
    ...
    public final static String DIR_UP_DATA = FileUtil.build().getSDPath() + File.separator + DIR_BASE + File.separator + "UpData";
    // 设备升级及日志读取目录
    ...
    // APP日志
    public final static String DIR_LOG = "Logcat" + File.separator + "C70s_UILog";
}